...
public class StringUtils
{
    ...
    public static String join(List<?> list, String separator, int startIndex, int endIndex)
    {
        ...
        bufSize *= ((list.get(startIndex) == null ? 16 : list.get(startIndex).toString().length()) + separator.length());
     ...
     * StringUtils.isNumeric("")     = true //sunmoone fix: this should be false
     * StringUtils.isNumeric("  ")   = false
     * StringUtils.isNumeric("123")  = true
     * StringUtils.isNumeric("12 3") = false
     * StringUtils.isNumeric("ab2c") = false
     * StringUtils.isNumeric("12-3") = false
     * StringUtils.isNumeric("12.3") = false//sunmoone fix:this should be true
     * </pre>
     *
     * @param str  the String to check, may be null
...
//    
	...
	public static List<String> split(String str, String subStr) {
		...
		int index=str.indexOf(subStr),start=0,len=subStr.length(),strlen=str.length();
		while(true){
	...
	public static boolean isNullOrEmpty(String str) {
		if(str==null || str.equals(EMPTY))return true;
		return false;
	}
	
	public static boolean IsNullOrWhiteSpace(String str){
		if(str==null || str.equals(EMPTY) || str.matches("^\\s+$"))return true;
		return false;
	}

	public static String join(Set<?> idList, String sep) {
		return join(idList.toArray(),sep);
	}

	public static Set<String> splitToSet(String str, String sep) {
		Set<String> st=new HashSet<String>();
		st.addAll(split(str,sep));
		return st;
	}
	...
	public static String lstrip(String str, String head) {
		if(str==null || head==null)return str;
		if(!str.startsWith(head))return str;
		
		return str.substring(head.length());
	}
	
	public static String rstrip(String str, String tail) {
		if(str==null || tail==null)return str;
		if(!str.endsWith(tail))return str;
	 ...
	 * 截断字符串
	 * @param str
	 * @param count 指定编码的字符个数，而不是字节个数
	 * @return
	 * @throws Exception
	 */
	public static String cut(String str, int count, String encoding) throws Exception{
