...
public class SecurityImage {
    ...
    /**
     * 使用指定源生成验证码
     * @param symbolCount    验证码长度
     * @param sources   验证码字符源
     * @return
     */
    public static String generateVerifyCode(int symbolCount){
...
//        }
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
        ...
        Color c =  new Color(220,240,230);//getRandColor(200, 250);
        g2.setColor(c);// 设置背景色
        g2.fillRect(0, 2, w, h-4);
         
      //绘制干扰线
        g2.setColor(getRandColor(60, 80));// 设置线条的颜色
        for (int i = 0; i < 5; i++) {
        ...
        for(int i = 0; i < symbolCount; i++){
            ...
            affine.setToRotation(Math.PI / 4 * random.nextDouble() * (random.nextBoolean() ? 1 : -1), (w / symbolCount) * i + fontSize/2, h/2);
      ...
      g2.setFont(font1);
      char[] chars1 = generateVerifyCode(10).toCharArray();
